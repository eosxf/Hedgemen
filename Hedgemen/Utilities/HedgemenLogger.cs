	...
	public class HedgemenLogger : ILogger
	{
		...
		private void Add(string message, LogLevel logLevel, StackFrame stackFrame)
		{
			...
			switch (logLevel)
			{
				...
				case LogLevel.Warn: consoleColor = ConsoleColor.Yellow; 
					break;
				case LogLevel.Error: consoleColor = ConsoleColor.Red;
					break;
				case LogLevel.Critical: consoleColor = ConsoleColor.Blue;
					break;
			}
